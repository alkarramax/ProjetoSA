...
public class ListaEntidade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_entidade);

        RecyclerView rv = findViewById(R.id.recyclerview_lista_entidade);
